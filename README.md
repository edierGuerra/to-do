...
- **Interfaz gráfica intuitiva**:
  - Desarrollada con **React** para una experiencia de usuario amigable y visualmente atractiva.
...
- **Persistencia de datos**:
  - Las tareas se guardan automáticamente en el local storage del navegador.
